...
class CmlBip32Ed25519 {
    ...
    fromBip39Entropy(entropy, passphrase) {
        ...
        return Promise.resolve((0, __1.Bip32PrivateKeyHex)(Buffer.from(hexKey).toString('hex')));
    }
    getPublicKey(privateKey) {
        return (0, util_1.usingAutoFree)((scope) => {
            ...
            return Promise.resolve((0, __1.Ed25519PublicKeyHex)(Buffer.from(pubKeyBytes).toString('hex')));
        });
    }
    getPubKeyHash(publicKey) {
        return (0, util_1.usingAutoFree)((scope) => {
            ...
            return Promise.resolve((0, __1.Ed25519KeyHashHex)(Buffer.from(keyHash).toString('hex')));
        });
    }
    getRawPrivateKey(bip32PrivateKey) {
        return (0, util_1.usingAutoFree)((scope) => {
            ...
            return Promise.resolve((0, __1.Ed25519PrivateExtendedKeyHex)(Buffer.from(bytes).toString('hex')));
        });
    }
    getRawPublicKey(bip32PublicKey) {
        return (0, util_1.usingAutoFree)((scope) => {
            ...
            return Promise.resolve((0, __1.Ed25519PublicKeyHex)(Buffer.from(bytes).toString('hex')));
        });
    }
    getBip32PublicKey(privateKey) {
        return (0, util_1.usingAutoFree)((scope) => {
            ...
            const pubKeyBytes = scope.manage(cmlPrivateKey.to_public()).as_bytes();
            return Promise.resolve((0, __1.Bip32PublicKeyHex)(Buffer.from(pubKeyBytes).toString('hex')));
        });
    }
    derivePrivateKey(parentKey, derivationIndices) {
        return (0, util_1.usingAutoFree)((scope) => {
            ...
            return Promise.resolve((0, __1.Bip32PrivateKeyHex)(Buffer.from(cmlKey.as_bytes()).toString('hex')));
        });
    }
    derivePublicKey(parentKey, derivationIndices) {
        return (0, util_1.usingAutoFree)((scope) => {
            ...
            return Promise.resolve((0, __1.Bip32PublicKeyHex)(Buffer.from(cmlKey.as_bytes()).toString('hex')));
        });
    }
    async sign(privateKey, message) {
        return (0, util_1.usingAutoFree)((scope) => {
            ...
            return Promise.resolve((0, __1.Ed25519SignatureHex)(Buffer.from(signature).toString('hex')));
        });
    }
